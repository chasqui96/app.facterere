...
class LoginController extends Controller
{
    ...
    {
        return view('frontend.usuario.login');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['nombre_usuario' => $request->username, 'password' => $request->password])) {
            Auth::user()->ultimo_login_usuario = date('Y-m-d H:i:s');
            Auth::user()->save();
            return redirect()->route('home')->with('success_message', 'Correcto, Bienvenido a Facterere.');
        } else {
            return redirect()->route('usuario-login')->with('error_message', 'Incorrecto, Usuario o Contraseña invalida.');
        }
    }
