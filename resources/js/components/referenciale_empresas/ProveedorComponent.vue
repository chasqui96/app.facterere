      ...
      <div class="card-body">
        ...
        <div class="tab-content tab-content-custom-pill" id="pills-tabContent-custom">
          ...
          >
            ...
            <form
              class="form-sample"
              @submit.prevent="editarDatos(proveedor)"
              v-if="modoEditar"
            >
                      <!-- CODIGO BOTONES -->
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <b-form-select v-model="proveedor.idpersona">
              ...
              <fieldset>
                ...
                <div class="col-lg-12">
                  ...
                  <b-table
                    ...
                    responsive
                  >
                    <template v-slot:cell(proveedor_estado)="{item}">
                      <b-badge
                        pill
                        :variant="getOrderStatusColor(item.proveedor_estado)"
                      >{{item.proveedor_estado}}</b-badge>
                    </template>
                    ...
                    <template v-slot:cell(actions)="row">
                      ...
                      <b-button
                        v-if="row.item.proveedor_estado === 'INACTIVO'"
                        size="sm"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { label: "Estado", key: "proveedor_estado" },
  ...
  methods: {
    getOrderStatusColor(proveedor_estado) {
      if (proveedor_estado === "ACTIVO") return "success";
      if (proveedor_estado === "INACTIVO") return "danger";
    },
    listar() {
      axios
        .get("/proveedores")
    ...
    agregar() {
      const params = {
        ...
        persona: this.proveedor.idpersona
      };
      (this.proveedor.estado = ""),
        (this.proveedor.idpersona = ""),
        axios
          .post("/guardar-Proveedor", params)
          .then(res => {
    ...
    editarFormulario(item) {
      this.proveedor.id_proveedor = item.id_proveedor;
      this.proveedor.idpersona = item.id_persona;
      this.modoEditar = true;
      document.getElementById("pills-home-tab-custom").click();
    },
    editarDatos(proveedor) {
      const params = {
        persona: proveedor.idpersona
      };
      axios
        .put(`/editar-Proveedor/${proveedor.id_proveedor}`, params)
        .then(res => {
          this.modoEditar = false;
          const index = this.items.findIndex(
            item => item.id_proveedor === proveedor.id_proveedor
          );
    ...
    Cambiar(item, operacion) {
      const params = {
        ...
        estado: item.proveedor_estado,
        operacion: operacion
      };
      axios.put(`/cambiar-Proveedor/${item.id_proveedor}`, params).then(res => {
        this.items.push = res.data;
        this.listar();
