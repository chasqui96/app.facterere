  ...
  <div class="row justify-content-md-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <fieldset>
            <legend>FORMLARIO CARGO</legend>
            <form class="forms-sample" @submit.prevent="editarDatos(cargo)" v-if="modoEditar">
...
export default {
  ...
  methods: {
    ...
    editarFormulario(item) {
      this.cargo.id_cargo = item.id_cargo;
      this.cargo.descripcion = item.cargo_descripcion;
    ...
    editarDatos(cargo) {
      ...
      axios.put(`/editar-Cargo/${cargo.id_cargo}`, params).then(res => {
        this.modoEditar = false;
        const index = this.items.findIndex(
          item => item.id_cargo === cargo.id_cargo
        );
    ...
    eliminarDatos(cargo, index) {
      swal({
        ...
        if (willDelete) {
          axios.delete(`/eliminar-Cargo/${cargo.id_cargo}`).then(() => {
