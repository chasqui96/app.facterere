  ...
  <div class="row justify-content-md-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <fieldset>
            <legend>FORMLARIO CATEGORIA</legend>
            <form class="forms-sample" @submit.prevent="editarDatos(categoria)" v-if="modoEditar">
...
export default {
  ...
  methods: {
    ...
    editarFormulario(item) {
      ...
      this.categoria.descripcion = item.categoria_descripcion;
    ...
    editarDatos(categoria) {
      ...
      axios.put(`/editar-Categoria/${categoria.id_categoria}`, params).then(res => {
    ...
    eliminarDatos(categoria, index) {
      swal({
        ...
        if (willDelete) {
          axios.delete(`/eliminar-Categoria/${categoria.id_categoria}`).then(() => {
