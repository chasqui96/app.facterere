  ...
  <div class="row justify-content-md-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <fieldset>
            <legend>FORMLARIO BLOQUE</legend>
            <form class="forms-sample" @submit.prevent="editarDatos(bloque)" v-if="modoEditar">
              <div class="form-group">
                <label>DESCRIPCION</label>
                <input
                  type="text"
                  class="form-control w-200"
                  v-model="bloque.descripcion"
...
export default {
  ...
  methods: {
    ...
    agregar() {
      ...
      this.bloque.descripcion = "";
    },
    editarFormulario(item) {
      this.bloque.id_bloque = item.id_bloque;
      this.bloque.descripcion = item.bloques_descripcion;
    ...
    editarDatos(bloque) {
      ...
      axios.put(`/editar-Bloque/${bloque.id_bloque}`, params).then(res => {
        this.modoEditar = false;
        const index = this.items.findIndex(
          item => item.id_bloque === bloque.id_bloque
        );
    ...
    eliminarDatos(bloque, index) {
      swal({
        ...
        if (willDelete) {
          axios.delete(`/eliminar-Bloque/${bloque.id_bloque}`).then(() => {
